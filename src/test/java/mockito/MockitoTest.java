...
public class MockitoTest {
	...
	public void consecutive_calls() {
		...
		when(mockList.get(0)).thenReturn(2); // 最後一個有效
	...
	public void returnsSmartNullsTest() {
		...
		// 使用RETURNS_SMART_NULLS参数创建的mock对象，不会抛出NullPointerException异常。另外控制台窗口会提示信息“SmartNull
		// returned by unstubbed get() method on mock”
